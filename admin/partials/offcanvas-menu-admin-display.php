...
<h2 class="enweby-plugin-title"><img src="<?php echo plugin_dir_url( dirname( __FILE__ ) ) .'images/enweby-logo.png'; ?>" title="Enweby Solutions" alt="Enweby Solutions" /> - Offcanvas Mobile Menu</h2>
