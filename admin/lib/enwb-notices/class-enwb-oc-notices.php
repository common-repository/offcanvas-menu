...
if ( ! class_exists( 'Enwb_Oc_Notices' ) ) :
	...
	class Enwb_Oc_Notices {
		 ...
		 * @since 1.0.0
		 */
		private $plugin_name_dashed = OFFCANVAS_MENU_PLUGIN_NAME;
		 ...
		 * @since 1.0.0
		 */
		private static $version = OFFCANVAS_MENU_PLUGIN_VERSION;
